...
export default async function Videos() {
  ...
  return (
    <section id="videos" className="py-32 relative bg-gradient-to-b border-t border-white/5 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <SectionHeading
          title="Content "
          highlight="Creation"
          subtitle="Engineering failures, successes, and everything in between."
          color="#ef4444"
          align="left"
        />
      </div>
