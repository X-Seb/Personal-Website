  ...
  return (
    <FadeUp delay={index * 0.1}>
      <Link
        href={video.link}
        target="_blank"
        className="group block relative shrink-0 bg-neutral-900 backdrop-blur-xl border-4 border-white/5 rounded-2xl overflow-hidden hover:border-red-500/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(239,68,68,0.2)]"
      >
