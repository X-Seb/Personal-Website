...
export default function Hero(){
    return (
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          I BUILD <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600">ROBOTS</span>
        </motion.h1>
        ...
        >
          Founder. Engineer. Turning complex code into physical movement.
        </motion.p>
