  ...
  return (
    <section id="hero" className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
        <FadeUp duration={0.8} className="text-6xl md:text-8xl font-bold tracking-tight text-white mb-6">
          I BUILD{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600">ROBOTS</span>
        </FadeUp>

        <FadeUp delay={0.3} duration={0.8} className="text-xl text-neutral-300 mb-8 max-w-2xl mx-auto">
